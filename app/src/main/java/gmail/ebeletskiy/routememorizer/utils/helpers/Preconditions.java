package gmail.ebeletskiy.routememorizer.utils.helpers;
...
public final class Preconditions {
   ...
   */
  public static void checkStringNotEmpty(String s, @Nullable String errorMessage) {
    if (TextUtils.isEmpty(s)) throw new IllegalStateException(errorMessage);
  }
